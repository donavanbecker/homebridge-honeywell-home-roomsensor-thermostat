...
export class RoomSensorThermostatPlatform implements DynamicPlatformPlugin {
  ...
  async discoverDevices() {
    ...
    this.log.debug(`# of Locations Found: ${locations.length}.`);
    ...
    for (const location of locations) {
      ...
      for (const device of location.devices) {
        ...
        if ((device.deviceID.startsWith('LCC')) === true) {
              ...
              for (const accessories of accessory.rooms) {
                ...
                for (const findaccessories of accessories.accessories) {
                  ...
                  if (findaccessories.accessoryAttribute.type === 'IndoorAirSensor'
                    ...
                    this.log.debug(`UDID: 
                      ${accessories.name}${findaccessories.accessoryAttribute.type}${findaccessories.accessoryAttribute.serialNumber}`);
                    ...
                    if (existingAccessory) {
                      ...
                      if (device.isAlive) {
                        ...
                        new RoomSensorThermostat(this, existingAccessory, locationId, device, findaccessories, group, accessories);
                      ...
                      // this is imported from `platformAccessory.ts`
                      new RoomSensorThermostat(this, accessory, locationId, device, findaccessories, group, accessories);
                    ...
                    this.log.info(`${accessories.name} ${findaccessories.accessoryAttribute.type} was found.`);
                  } else {
                    // eslint-disable-next-line max-len
          ...
          this.log.info('A Device was found with a Device ID that didn\'t starts with LCC.');
        }
      }
    }
  }
